#!/usr/bin/env python3
"""Convert article HTML from SQLite to Markdown via markitdown."""
...
DEFAULT_OUT_DIR = "./data/md_compare/markitdown"
...
def convert_html_to_markdown(converter: MarkItDown, html: str) -> str:
...
def main() -> int:
    ...
    for article in articles:
        ...
        markdown = convert_html_to_markdown(converter, article["html"])
